...
function SensorEditor({uuid}: EditorProps) {
    ...
    return (
        <div className="h-screen overflow-hidden pb-5">
            ...
            <div className="m-5 grid grid-cols-12 h-screen overflow-hidden">
                <div className="p-2 rounded bg-white mr-6 shadow col-span-3 overflow-hidden mb-5 box-border">
                    <Label>
                        Sensors
                    </Label>
                    <ul className="h-auto">
                        ...
                        {sensors?.docs.map(doc => {
                            ...
                            return (
                                <li
                                    className={"py-4 flex items-center justify-between border-b border-gray-400 cursor-pointer group " + additionalClass}
                ...
                <div className="col-span-9 overflow-hidden flex w-full flex-col h-full box-border">
                    <div className="bg-white rounded shadow h-56 mb-5 transition duration-500 overflow-hidden flex items-center justify-center">
                        ...
                        {displayDetail && <SensorEditor uuid={editorUUID}/>}
                    </div>
                    <div className="bg-white rounded shadow flex-grow-1 p-2 transition duration-100 w-full h-full">
                        ...
                        >
                            <Marker coordinates={[-83.002389, 39.959194]} onClick={() => setDisplayDetail(!displayDetail)}>
                                <div className="w-8 h-8 bg-white rounded-lg flex items-center" style={{backgroundColor: "#47B35C"}}>
